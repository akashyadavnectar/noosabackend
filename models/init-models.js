...
function initModels(sequelize) {
  ...
  var reimbursement_doctor_master = _reimbursement_doctor_master(
    sequelize,
    DataTypes
  );
  var reimbursement_doctors = _reimbursement_doctors(sequelize, DataTypes);
  var reimbursement_service_master = _reimbursement_service_master(
    sequelize,
    DataTypes
  );
  ...
  claims.hasMany(claim_documents, {
    as: "claim_documents",
    foreignKey: "claim_id",
  });
  user_notification.belongsTo(notification_master, {
    as: "notification",
    foreignKey: "notification_id",
  });
  notification_master.hasMany(user_notification, {
    as: "user_notifications",
    foreignKey: "notification_id",
  });
  user_policies.belongsTo(policies, { as: "policy", foreignKey: "policy_id" });
  policies.hasMany(user_policies, {
    as: "user_policies",
    foreignKey: "policy_id",
  });
  reimbursement_doctors.belongsTo(reimbursement, {
    as: "reimbursement",
    foreignKey: "reimbursement_id",
  });
  reimbursement.hasMany(reimbursement_doctors, {
    as: "reimbursement_doctors",
    foreignKey: "reimbursement_id",
  });
  reimbursement_services.belongsTo(reimbursement, {
    as: "reimbursement",
    foreignKey: "reimbursement_id",
  });
  reimbursement.hasMany(reimbursement_services, {
    as: "reimbursement_services",
    foreignKey: "reimbursement_id",
  });
  reimbursement_doctors.belongsTo(reimbursement_doctor_master, {
    as: "doctor",
    foreignKey: "doctor_id",
  });
  reimbursement_doctor_master.hasMany(reimbursement_doctors, {
    as: "reimbursement_doctors",
    foreignKey: "doctor_id",
  });
  reimbursement_services.belongsTo(reimbursement_service_master, {
    as: "service",
    foreignKey: "service_id",
  });
  reimbursement_service_master.hasMany(reimbursement_services, {
    as: "reimbursement_services",
    foreignKey: "service_id",
  });
  claims.belongsTo(user_policies, {
    as: "userPolicy",
    foreignKey: "userPolicy_id",
  });
  user_policies.hasMany(claims, { as: "claims", foreignKey: "userPolicy_id" });
  complaints.belongsTo(user_policies, {
    as: "userPolicy",
    foreignKey: "userPolicy_id",
  });
  user_policies.hasMany(complaints, {
    as: "complaints",
    foreignKey: "userPolicy_id",
  });
  premiums.belongsTo(user_policies, {
    as: "userPolicy",
    foreignKey: "userPolicy_id",
  });
  user_policies.hasMany(premiums, {
    as: "premia",
    foreignKey: "userPolicy_id",
  });
  service_request.belongsTo(user_policies, {
    as: "userPolicy",
    foreignKey: "userPolicy_id",
  });
  user_policies.hasMany(service_request, {
    as: "service_requests",
    foreignKey: "userPolicy_id",
  });
  user_notification.belongsTo(users, { as: "user", foreignKey: "user_id" });
  users.hasMany(user_notification, {
    as: "user_notifications",
    foreignKey: "user_id",
  });
  ...
  users.hasMany(user_policies, {
    as: "user_user_policies",
    foreignKey: "user_id",
  });
